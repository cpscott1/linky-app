        ...
        >
            <div class="mx-auto max-w-7xl">
                ...
                <div class="container py-32 mx-auto text-center sm:px-4">
                    ...
                    @csrf
                    <div
                    class="text-sm mb-10 text-indigo-300" data-primary="indigo-600">
                    Right click to copy link
                    </div>
                      <span class="relative top-0 right-0 block">
                          <a href="http://localhost:8080/{{ $short_url }}"
                          type="submit"
                          class="inline-flex items-center w-full h-12 px-8 text-base font-bold leading-6 text-white transition duration-150 ease-in-out bg-indigo-400 border border-transparent hober:bg-indigo-700 focus:outline-none active:bg-indigo-700" data-primary="indigo-600"
                          >http://localhost:8080/{{ $short_url }}</a>
                      </span>  
                    </form>
                </div>
            </div>
